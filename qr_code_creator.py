...
def generate_qr_with_logo(url, logo_path, qr_color, bg_color, output_file="qr-code.png"):
...
# Параметры
url = "https://drive.google.com/file/d/1ju8jPwiru1BgkLkICzw6E6qgPJxt9lSW/view?usp=sharing"  # Замени на свою ссылку
...
qr_color = (79, 209, 197)  # Цвет #4fd1c5 в RGB
bg_color = "white"  # Фон белый
output_file = "qr-code.png"

generate_qr_with_logo(url, logo_path, qr_color, bg_color, output_file)